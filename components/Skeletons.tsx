...
/**
 * High-aesthetic Obsidian Glass Skeleton loaders
 * Designed with subtle cyan-sheen gradients to match the obsidian bento theme.
 */

export function ForumSkeleton() {
  return (
    <section className="w-full max-w-[1400px] mx-auto pt-24 pb-20 px-4 sm:px-6 lg:px-8 animate-in fade-in duration-300">
      {/* Header Skeleton */}
