  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-50 rounded-[inherit] overflow-hidden pointer-events-none">
        <div className="absolute inset-0 bg-gradient-to-tr from-transparent via-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700" style={{ transform: 'translateZ(20px)', willChange: 'opacity' }} />
      </div>
      ...
      <div className="absolute inset-4 -z-10 bg-black/60 blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-[inherit]"
        style={{ transform: "translateZ(-40px) scale(0.9)", willChange: 'opacity' }} />
    </motion.div>
  );
};
