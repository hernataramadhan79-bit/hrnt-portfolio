...
const Library: React.FC = () => {
  ...
  return (
    <section id="library" className="relative z-10 py-12 md:py-20 px-4 sm:px-6">
            ...
            >
              <motion.button
                ...
                className={`relative flex items-center justify-center h-10 rounded-full text-sm font-medium transition-colors duration-300 ${
                  filter === 'projects' ? 'text-black px-4' : 'text-slate-400 hover:text-white px-3 hover:bg-white/5'
                }`}
              ...
              <motion.button
                ...
                className={`relative flex items-center justify-center h-10 rounded-full text-sm font-medium transition-colors duration-300 ${
                  filter === 'certificates' ? 'text-black px-4' : 'text-slate-400 hover:text-white px-3 hover:bg-white/5'
                }`}
                style={{ WebkitTapHighlightColor: "transparent" }}
                transition={{ type: "spring", stiffness: 500, damping: 30 }}
              >
