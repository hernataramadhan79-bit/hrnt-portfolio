...
const Forum: React.FC = () => {
    ...
    return (
        <section id="forum" className="relative z-10 min-h-[calc(100dvh-5rem)] md:min-h-[calc(100vh-6rem)] flex flex-col justify-center w-full py-12 lg:py-16 px-4 sm:px-6 overflow-hidden">
