...
const Forum: React.FC = () => {
  ...
  const spotlight = useMotionTemplate`radial-gradient(600px circle at ${mouseX}px ${mouseY}px, rgba(34,211,238,0.06), transparent 80%)`;
  ...
  return (
    <section id="forum" className="w-full max-w-[1400px] mx-auto pt-24 pb-20 px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        {/* Left Column: Auth & Submission Dock (Span 5 - 38.2%) */}
        <motion.div
        ...
        >
          <div
            ...
            className="glass-card p-6 sm:p-8 relative overflow-hidden isolate border-neutral-800/80"
          >
            <motion.div
            ...
            {/* Security Badge */}
            <div className="mt-6 pt-4 border-t border-neutral-800/80 flex items-center justify-between text-[11px] text-neutral-500 font-mono">
        ...
        {/* Right Column: Comment Stream (Span 7 - 61.8%) */}
        <motion.div
          initial={{ opacity: 0, x: 8 }}
          whileInView={{ opacity: 1, x: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.28, ease: [0.22, 1, 0.36, 1] }}
          className="lg:col-span-7 glass-card p-6 sm:p-8 flex flex-col justify-between border-neutral-800/80"
        >
